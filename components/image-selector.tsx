...
const ImageSelector = <T,>({control, name}: UseControllerProps<T>) => {
    ...
    // useCallbackの第二引数の配列を指定すると、その条件に変更が加えられるまで一度作った関数が使われる
      ...
      <div>
        <div 
            className={classNames(
                'aspect-square relative rounded-full overflow-hidden w-40 grid content-center border border-slate-300 border-2 border-dashed hover:cursor-pointer hover:bg-blue-100',
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel 
                    ...
                    <div>
                        <AvatarEditor
                            // AvatarEditorの値を直接取り出すためのプロパティ。クロップした画像が取得できる
                            ref={ref}
                            image={selectedImage}
                            width={250}
                            height={250}
